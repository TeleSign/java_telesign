...
public class VoiceClientTest extends TestCase {
    ...
    public void testVoiceClientConstructorMinimal() throws Exception {
        VoiceClient client = new VoiceClient(customerId, apiKey);
        assertNotNull(client);
    }


    public void testVoiceClientConstructorFull() throws Exception {
        VoiceClient client = new VoiceClient(customerId,
                apiKey,
                "rest endpoint",
                0,
                0,
    ...
    public void testVoiceWithParams() throws Exception {
        ...
        client.call("18005555555", "Test Message Content", "MKT", params);
    ...
    public void testVoiceNullParams() throws Exception {
        ...
        client.call("18005555555", "Test Message Content", "ARN", null);
    ...
    public void testVoiceStatus() throws Exception {
        ...
        assertEquals("path is not as expected", "/v1/voice/FakeReferenceId", request.getPath());
