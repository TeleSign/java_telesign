...
public class    Verify {
	 ...
	 * @return  A {@link com.telesign.verify.response.VerifyResponse} object, which contains the JSON-formatted response body from the TeleSign server.
	 */
	public VerifyResponse registration(String phone_number){
		return registration(phone_number, null, null, null);
	}
	 ...
	 * @return  A {@link com.telesign.verify.response.VerifyResponse} object, which contains the JSON-formatted response body from the TeleSign server.
	 */
	public VerifyResponse registration(String phone_number, String mobile_app_signature, String originating_ip, String session_id){
		String result = null;

		try {

			TeleSignRequest tr = new TeleSignRequest("https://rest.telesign.com", "/v1/verify/registration/" + phone_number, "GET", customer_id, secret_key, connectTimeout, readTimeout);
			
			if(null != mobile_app_signature && !mobile_app_signature.isEmpty()) {

				tr.addParam("mobile_app_signature", mobile_app_signature);
			}
