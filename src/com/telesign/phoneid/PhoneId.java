...
public class PhoneId {
     ...
     * @param secret_key  [Required] A string representing your TeleSign Secret Key
     ...
     *
     * @param phone_number [Required] A string representing the phone number you want
     *                     information about.
    ...
    public PhoneIdStandardResponse standard(String phone_number) {
        ...
        try {
            ...
            TeleSignRequest tr = new TeleSignRequest(
                    getTelesign_url(), "/v1/phoneid/standard/"
    ...
    public PhoneIdScoreResponse score(String phone_number, String ucid) {
        ...
        try {
            ...
            TeleSignRequest tr = new TeleSignRequest(
                    getTelesign_url(), "/v1/phoneid/score/"
                    + phone_number, "GET", customer_id, secret_key);
    ...
    public PhoneIdContactResponse contact(String phone_number, String ucid) {
        ...
        try {
            ...
            TeleSignRequest tr = new TeleSignRequest(
                    getTelesign_url(), "/v1/phoneid/contact/"
                    + phone_number, "GET", customer_id, secret_key);
            tr.addParam("ucid", ucid);
    ...
    public PhoneIdLiveResponse live(String phone_number, String ucid) {
        ...
        try {
            ...
            TeleSignRequest tr = new TeleSignRequest(
                    getTelesign_url(), "/v1/phoneid/live/"
                    + phone_number, "GET", customer_id, secret_key);
            tr.addParam("ucid", ucid);
