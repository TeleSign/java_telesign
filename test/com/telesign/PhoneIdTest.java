...
/*	@Test
    ...
    @Test
    public void phoneIdStandardNotEnabled() {
        if (CUSTOMER_ID.isEmpty() || SECRET_KEY.isEmpty()) {
            fail("CUSTOMER_ID and SECRET_KEY must be set to pass this test");
        }
        ...
        PhoneIdStandardResponse ret = pid.standard("13102224444");
        assertNotNull(ret);
        assertTrue(ret.errors.length == 1);
        assertTrue(ret.status.code == 501);
        assertTrue(ret.errors[0].code == -20002);
...
/*	@Test
    ...
    @Test
    public void phoneIdScoreProductNotEnabled() {
        if (CUSTOMER_ID.isEmpty() || SECRET_KEY.isEmpty()) {
            fail("CUSTOMER_ID and SECRET_KEY must be set to pass this test");
        }
...
*/
    ...
    @Test
    public void phoneIdContactNotEnabled() {
        if (CUSTOMER_ID.isEmpty() || SECRET_KEY.isEmpty()) {
            fail("CUSTOMER_ID and SECRET_KEY must be set to pass this test");
        }
...
/*	@Test
    ...
    @Test
    public void phoneIdLiveDummyNotEnabled() {
        if (CUSTOMER_ID.isEmpty() || SECRET_KEY.isEmpty()) {
            fail("CUSTOMER_ID and SECRET_KEY must be set to pass this test");
        }
...
*/
    ...
    @Test
    public void phoneIdLiveRealNotEnabled() {
        ...
        assertNotNull(ret2);
        assertTrue(ret2.errors.length == 1);
        assertTrue(ret2.status.code == 501);
        assertTrue(ret2.errors[0].code == -20002);
    }
